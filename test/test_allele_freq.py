...
class Platform(unittest.TestCase):
    ...
    execution = "platform"
    profile_name = 'bdc'
    log_filename = 'UnitTest_allele_freq'
    ...
    def setUpClass(cls):
        ...
        cls.APP = 'smgogarten/qc-for-gwas-development/allele-frequency'
        cls.inputs = {}
        cls.TASK_NAME = 'UnitTest_AlleleFreq'
        ...
        cls.inputs['gds_file'] = cls.session.files.query(
            names=['1KG_phase3_subset_chrX.gds'],
            project=cls.project
        )[0]
        cls.inputs['sample_adf'] = cls.session.files.query(
            names=['1KG_phase3_subset_annot.rds'],
            project=cls.project
        )[0]
        ...
        cls.inputs['sample_id'] = cls.session.files.query(
    ...
    def test_outputs(self):
        ...
        if self.task.status == 'COMPLETED':
            ...
            out_expected_name = 'unittest_allele_freq.rds'
            out_name = self.task.outputs['allele_freq'].name
            ...
            out_expected_name = 'unittest_allele_freq.pdf'
