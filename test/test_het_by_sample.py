...
input_gds_file = '1KG_phase3_subset_chr22.gds'
input_out_prefix = 'unittest'
input_maf_min = 0.01
input_maf_max = 0.49
input_pass_only = False
input_cpu = 2
...
if __name__ == "__main__":
    #unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(report_name="Heterozygosity by sample", report_title="Heterozygosity by sample"))
