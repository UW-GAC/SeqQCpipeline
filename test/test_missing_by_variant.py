...
class Platform(unittest.TestCase):
    ...
    execution = "platform"
    profile_name = 'bdc'
    log_filename = 'UnitTest_missing_by_variant'
    ...
    def setUpClass(cls):
        ...
        cls.APP = 'smgogarten/qc-for-gwas-development/missing-rate-by-variant'
        cls.inputs = {}
        cls.TASK_NAME = 'UnitTest_MissingByvariant'
        ...
        cls.inputs['gds_file'] = cls.session.files.query(
            names=['1KG_phase3_subset_chr22.gds'],
            project=cls.project
        )[0]
    ...
    def test_outputs(self):
        ...
        if self.task.status == 'COMPLETED':
            ...
            out_expected_name = 'unittest_missing_by_variant.rds'
            out_name = self.task.outputs['missing_by_variant'].name
            ...
            out_expected_name = 'unittest_missing_by_variant.pdf'
